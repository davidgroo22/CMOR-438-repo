...
Then, the Perceptron turns the raw value into an actual prediction using the sign function which simply takes the sign of the output and we call that prediction $hat{y}$ 